...
// ==========================
TCLIB_API TCLIB_STATUS EVP_HashInit(EVP_HASH_CTX *ctx, const EVP_MD *md);
TCLIB_API EVP_HASH_CTX* EVP_HashInitAlloc(const EVP_MD *md, TCLIB_STATUS *status);

TCLIB_API TCLIB_STATUS EVP_CShakeInit(EVP_HASH_CTX *ctx, const EVP_MD *md,
                                 const uint8_t *N, size_t N_len,
                                 const uint8_t *S, size_t S_len);

TCLIB_API EVP_HASH_CTX* EVP_CShakeInitAlloc(const EVP_MD *md,
                                        const uint8_t *N, size_t N_len,
                                        const uint8_t *S, size_t S_len,
                                        TCLIB_STATUS *status);
...
// ==========================
TCLIB_API TCLIB_STATUS EVP_ComputeCShake(
    const EVP_MD *md,
    uint8_t *digest,
    const uint8_t *data,
    size_t data_len,
