...
static void store_uint128(uint8_t out[AES_BLOCK_SIZE], uint128_t x) {
    out[0]  = x.hi >> 56; out[1]  = x.hi >> 48; out[2]  = x.hi >> 40; out[3]  = x.hi >> 32;
    out[4]  = x.hi >> 24; out[5]  = x.hi >> 16; out[6]  = x.hi >> 8;  out[7]  = x.hi;
    out[8]  = x.lo >> 56; out[9]  = x.lo >> 48; out[10] = x.lo >> 40; out[11] = x.lo >> 32;
    out[12] = x.lo >> 24; out[13] = x.lo >> 16; out[14] = x.lo >> 8;  out[15] = x.lo;
}
