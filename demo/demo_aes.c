...
void test_aes_ecb_fist800_38a(void) {
    ...
    ll_AES_ECB_Encrypt(&ctx, plain_text, AES_BLOCK_SIZE, ct);
    ll_AES_ECB_Decrypt(&ctx, ct, AES_BLOCK_SIZE, dec);

    printf("AES-128 ECB Test:\n");
    printf("Plaintext: "); DEMO_print_hex(plain_text, AES_BLOCK_SIZE);
    printf("Ciphertext:"); DEMO_print_hex(ct, AES_BLOCK_SIZE);
    printf("Expected:  "); DEMO_print_hex(expected_ct128, AES_BLOCK_SIZE);
    printf("Decrypted: "); DEMO_print_hex(dec, AES_BLOCK_SIZE);
    ...
    printf("Plaintext: "); DEMO_print_hex(plain_text, AES_BLOCK_SIZE);
    printf("Ciphertext:"); DEMO_print_hex(ct, AES_BLOCK_SIZE);
    printf("Expected:  "); DEMO_print_hex(expected_ct192, AES_BLOCK_SIZE);
    printf("Decrypted: "); DEMO_print_hex(dec, AES_BLOCK_SIZE);
    ...
    printf("Plaintext: "); DEMO_print_hex(plain_text, AES_BLOCK_SIZE);
    printf("Ciphertext:"); DEMO_print_hex(ct, AES_BLOCK_SIZE);
    printf("Expected:  "); DEMO_print_hex(expected_ct256, AES_BLOCK_SIZE);
    printf("Decrypted: "); DEMO_print_hex(dec, AES_BLOCK_SIZE);
