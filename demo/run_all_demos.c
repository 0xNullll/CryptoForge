...
int main(void) {
    ...
    static const uint8_t expected_kmacxof128[] = {
        ...
        0xd6, 0x00, 0x47, 0x80, 0xf7, 0xdf, 0x6a
    };
    ...
    // Expected lengths
    static const size_t expected_lens[4] = {
    ...
    test_all_kmacs_verify_array(key, strlen((char*)key), (uint8_t*)input, input_len, (uint8_t*)input, input_len, expected_digests, expected_lens);
