 ...
 * CF_StatusToStr
 *
 * Converts a CF_STATUS code into a human-readable string.
 *
 * This function is intended for debugging, logging, and diagnostics.
 * The returned string is a static, null-terminated constant and must
 * not be modified or freed by the caller.
 *
 * Returns:
 *   const char* - pointer to a string representing the status code
 *
 * Parameters:
 *   status - CF_STATUS value to convert
 */
